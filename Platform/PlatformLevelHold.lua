...
local BASELINE_MASS              = 489.0 
local GRAVITY                    = 11.0 -- Adjust to 9.81 if environment uses standard g

-- Dynamic Flight Targets
local TARGET_ALTITUDE = 10.0 -- Usually positive unless your world frame is inverted
local TARGET_PITCH    = 0.0
local TARGET_ROLL     = 0.0

local MIN_POWER_THRESHOLD = 6.5    -- Hardware ignition threshold (%)
local BASE_CONTROL_POWER  = 1.0    -- Virtual base (%)
local MAX_CONTROL_DELTA   = 5.0    -- Moderate differential range (%)
